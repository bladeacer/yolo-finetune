...
\begin{document}
  ...
  View the \href{https://universe.roboflow.com/stuff-avvl2/yolo-fine-y444l}{Labelled dataset} on Roboflow. This link contains the \href{https://images.cv/dataset/water-buffalo-image-classification-dataset}{Buffalo dataset}. This link contains the \href{https://images.cv/dataset/camel-image-classification-dataset}{Camel dataset}.
  ...
  This link contains \href{https://github.com/amikelive/coco-labels/blob/master/coco-labels-2014_2017.txt}{COCO 2014 - 2017 labels}.
    ...
    \begin{align*}
        ...
        &y \text{split, be the number of data augmentations used.} \\
        &\text{It is established that } x = 1,643 \text { and } y = 4 \\
        &\therefore x \times (4+1) = 8,215 \text{ total images after augmentation (Q.E.D.)}
    \end{align*}

    Note: We add 1 to the multiplication to account for the base image set.

    \subsection{Evaluation}
    We make use of wandb to evaluate metrics of our trained model.
    The best \textbf{mAP50} was found to average about .
    The best \textbf{mAP50-95} was found to average about .
    Both Precision and Recall is important here, hence we will evaluate the F1 score.
    ...
    After deployment, we verify that the model is able to detect occurrences of the object classes when provided with a sample image or video.
    \section{Conclusion}
