...
\begin{document}
  ...
  This link contains \href{https://github.com/amikelive/coco-labels/blob/master/coco-labels-2014_2017.txt}{COCO 2014 - 2017 labels}.
    ...
    There are inherent limitations in the existing dataset, such as a lack of images for younger camels or buffaloes. There is also an estimated 500:1300 camel-buffalo imbalance in the initial data before labelling.
    However, data augmentation and proper finetuning has ensured that this imbalance does not affect the model performance much. The difference of Average Precision between these two object classes is only 4\% (0.859 for buffalo and 0.819 for camel). 
